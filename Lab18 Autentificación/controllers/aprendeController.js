...
exports.getMVC = (request, response, next) => {
    response.render('aprendeMVC');
}

exports.getSesionesCookies = (request, response, next) => {
    response.render('aprendeSesionesCookies');
}

exports.getBaseDatos = (request, response, next) => {
    response.render('aprendeBaseDatos');
}